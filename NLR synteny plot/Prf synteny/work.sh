...
#sed -n '6879,6883p' Solanum_jamesii.bed |awk 'BEGIN{OFS="\t"}{if($4~/_NLR_/){print $4,$1,$2,$3,$6,"1","red"}else{print $4,$1,$2,$3,$6,"1","blue"}}' > Solanum_jamesii.prf.bed
#sed -n '17191,17195p' Solanum_cardiophyllumC509.bed |awk 'BEGIN{OFS="\t"}{if($4~/_NLR_/){print $4,$1,$2,$3,$6,"2","red"}else{print $4,$1,$2,$3,$6,"2","blue"}}' > Solanum_cardiophyllumC509.prf.bed
#sed -n '16682,16686p' Solanum_chacoense.bed |awk 'BEGIN{OFS="\t"}{if($4~/_NLR_/){print $4,$1,$2,$3,$6,"3","red"}else{print $4,$1,$2,$3,$6,"3","blue"}}' > Solanum_chacoense.prf.bed
#sed -n '21155,21159p' Solanum_cajamarquenseC534.bed |awk 'BEGIN{OFS="\t"}{if($4~/_NLR_/){print $4,$1,$2,$3,$6,"4","red"}else{print $4,$1,$2,$3,$6,"4","blue"}}' > Solanum_cajamarquenseC534.prf.bed
#sed -n '36878,36882p' Solanum_neorossii.bed |awk 'BEGIN{OFS="\t"}{if($4~/_NLR_/){print $4,$1,$2,$3,$6,"5","red"}else{print $4,$1,$2,$3,$6,"5","blue"}}' > Solanum_neorossii.prf.bed
#sed -n '15797,15801p' Solanum_candolleanum.bed |awk 'BEGIN{OFS="\t"}{if($4~/_NLR_/){print $4,$1,$2,$3,$6,"6","red"}else{print $4,$1,$2,$3,$6,"6","blue"}}' > Solanum_candolleanum.prf.bed
#sed -n '27593,27597p' Solanum_tuberosum_phurejaC118.bed |awk 'BEGIN{OFS="\t"}{if($4~/_NLR_/){print $4,$1,$2,$3,$6,"7","red"}else{print $4,$1,$2,$3,$6,"7","blue"}}' > Solanum_tuberosum_phurejaC118.prf.bed
#sed -n '22672,22676p' Solanum_tuberosum_stenotomumC093.bed |awk 'BEGIN{OFS="\t"}{if($4~/_NLR_/){print $4,$1,$2,$3,$6,"8","red"}else{print $4,$1,$2,$3,$6,"8","blue"}}' > Solanum_tuberosum_stenotomumC093.prf.bed

######### reverse compliment these species to avoid inversions
awk 'BEGIN{OFS="\t"}{if($5=="+"){print $1,$2,10788641-$4,10788641-$3,"-",$6,$7}else{print $1,$2,10788641-$4,10788641-$3,"+",$6,$7}}' Solanum_cardiophyllumC509.prf.bed2 > Solanum_cardiophyllumC509.prf.reverse.bed
awk 'BEGIN{OFS="\t"}{if($5=="+"){print $1,$2,27025086-$4,27025086-$3,"-",$6,$7}else{print $1,$2,27025086-$4,27025086-$3,"+",$6,$7}}' Solanum_cajamarquenseC534.prf.bed2 > Solanum_cajamarquenseC534.prf.reverse.bed
